...
const PlacePage = () => {
  ...
  const [viewTag, setViewTag] = useState('전체 보기');
  ...
  const resubmitReview = (_review) => {
    const review = {
      rating: _review.userRating,
      user: _review.userID,
      comment: _review.reviewContent,
      place: _review.place,
      cluster: prevCluster,
  ...
  const OnClick = useCallback(async () => {
    ...
    try {
      ...
      if (response.status == 400) {
        ...
        /*
        console.log(
          response.json().then((data) => console.log(data['cluster']))
        );
        */
      } else {
    ...
    <div>
      ...
      <div className='flex justify-between'>
        ...
        <div className='flex gap-2 self-end'>
          <span className='font-medium'>믿을 수 있는 리뷰만</span>
          <input
            type='checkbox'
            checked={checked}
            onChange={(e) => {
        ...
        <div>
          <div className='font-semibold text-2xl flex justify-between mt-2'>
            ...
            <div className=''>
              ...
              >
                <option defaultValue='전체 보기'>전체 보기</option>
